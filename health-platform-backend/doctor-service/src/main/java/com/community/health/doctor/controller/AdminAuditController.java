...
import com.community.health.doctor.entity.AuditLog;
import com.community.health.doctor.repo.AuditLogRepository;
...
public class AdminAuditController {
  ...
  public org.springframework.http.ResponseEntity<String> export(@RequestParam(value = "from", required = false) String from,
    ...
    return org.springframework.http.ResponseEntity.ok()
      .header("Content-Disposition", "attachment; filename=doctor-audit.csv")
      .body(sb.toString());
  }
}
