...
import com.community.health.auth.entity.AuditLog;
import com.community.health.auth.repo.AuditLogRepository;
...
public class AdminAuditController {
  ...
  @GetMapping
  public ApiResponse<Page<AuditLog>> list(@RequestParam(required = false) String from,
  ...
  public org.springframework.http.ResponseEntity<String> export(@RequestParam(required = false) String from,
                                                               @RequestParam(required = false) String to,
                                                               @RequestParam(required = false) Long userId,
                                                               @RequestParam(required = false) String action) {
    ...
    return org.springframework.http.ResponseEntity.ok()
      .header("Content-Disposition", "attachment; filename=auth-audit.csv")
      .body(sb.toString());
  }
}
